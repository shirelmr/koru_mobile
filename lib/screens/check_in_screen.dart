  ...
  void _toggleRecording() {
    if (_isRecording) {
      ...
      ref.read(appProvider.notifier).updateDraft(
            ref.read(appProvider).draft.copyWith(
      ...
      _recordTimer = Timer.periodic(const Duration(seconds: 1), (t) {
        ...
        if (_recordSeconds >= 30) _toggleRecording();
      });
    }
  }
...
class _Header extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        const Text('Kōru', style: KoruTextStyles.headline),
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: isRecording
                    ? [
                        BoxShadow(
                          color: KoruColors.danger.withValues(alpha: 0.4),
                          blurRadius: 20,
                          spreadRadius: 4,
                        )
                      ]
        ...
        return Row(
          ...
          children: List.generate(20, (i) {
            ...
            return Container(
              ...
              height: height,
              decoration: BoxDecoration(
                color: KoruColors.sage.withValues(alpha: 0.8),
              ...
              SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (v) {
                    ...
                    onChanged(draft.copyWith(glucose: d));
                  },
                ),
              ),
            ],
